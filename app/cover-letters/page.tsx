...
const FEATURES = [
  ["Matched to the job", "Paste any job description and we generate a cover letter tailored to its exact requirements and keywords."],
  ["Sounds like you", "Choose a tone — professional, confident, or warm — and the letter keeps your authentic voice."],
  ["Recruiter-ready templates", "Clean, modern layouts that match your resume design and pass ATS parsing."],
  ["Achievement-driven", "We pull your strongest, most relevant wins from your resume so every letter earns the interview."],
  ["One click, any role", "Generate a fresh, customized letter for every application in seconds — no blank-page anxiety."],
  ["Edit and export", "Fine-tune the draft, then export to PDF or DOCX ready to send."],
];

const STEPS = [
  ["1", "Add the job", "Paste the job description you are applying for."],
  ["2", "Pick your tone", "Choose the style that fits the company and role."],
  ["3", "Generate & send", "Get a tailored letter in seconds, edit, and export."],
];
  ...
  return (
    <div style={{ background: C.surface, minHeight: "100vh" }}>
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10 text-center">
        <span className="inline-block rounded-full px-3 py-1 text-xs font-bold" style={{ background: "#EEF0FF", color: C.primary }}>COVER LETTERS</span>
        <h1 className="mx-auto mt-5 max-w-3xl text-4xl font-extrabold leading-tight md:text-5xl" style={{ color: C.ink }}>Cover letters that get you the interview.</h1>
        <p className="mx-auto mt-5 max-w-2xl text-lg" style={{ color: C.inkSoft }}>Generate a tailored, recruiter-ready cover letter for any job in seconds — matched to the role, powered by your resume.</p>
        <div className="mt-8 flex justify-center gap-3">
          <Link href="/cover-letters/write" className="rounded-full px-6 py-3 text-sm font-bold text-white" style={{ background: "linear-gradient(135deg, " + C.primary + ", " + C.primaryDark + ")" }}>Write my cover letter</Link>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="rounded-3xl px-8 py-12 text-center" style={{ background: "linear-gradient(135deg, " + C.primary + ", " + C.primaryDark + ")" }}>
          <h2 className="text-2xl font-extrabold text-white md:text-3xl">Ready to write your best cover letter?</h2>
          <p className="mx-auto mt-3 max-w-xl text-sm text-white/80">Tailored to every job, powered by your resume. No credit card needed.</p>
